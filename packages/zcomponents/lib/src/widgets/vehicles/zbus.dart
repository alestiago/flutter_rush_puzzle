...
class ZBusColorScheme {
  ...
  factory ZBusColorScheme.school() {
...
class ZBus extends StatelessWidget {
  ...
  static final ZBusTheme theme = ZBusTheme.school();
...
class _ZFloor extends StatelessWidget {
  ...
  factory _ZFloor.fromTheme(ZBusTheme theme) {
    return _ZFloor(
...
class _ZRoof extends StatelessWidget {
  ...
  factory _ZRoof.fromTheme(ZBusTheme theme) {
    return _ZRoof(
      width: theme.dimensionData.rearWidth,
      height: theme.dimensionData.bodyWidth,
...
class _ZBusBackSide extends StatelessWidget {
  ...
  // TODO(alestiago): Get theme from context.
  static final ZBusTheme _theme = ZBusTheme.school();

  @override
  Widget build(BuildContext context) {
    final body = ZRect(
      width: _theme.dimensionData.rearWidth,
      color: _theme.colorScheme.busColor,
      height: _theme.dimensionData.rearHeight,
      fill: true,
    );

    final window = _ZWindow.largeFromTheme(_theme);
    final fender = _ZFender.rearfromTheme(_theme);
    final leftLight = _ZLight.rearFromTheme(_theme);
    final rightLight = _ZLight.rearFromTheme(_theme);

    final lightHeight =
        _theme.dimensionData.fenderPosition.y + leftLight.diameter * 1.5;
      ...
      children: [
        ...
        ZPositioned(
          translate: ZVector.only(
            y: (body.height / 2) -
                (window.height / 2) -
                _theme.dimensionData.bodyTopPadding,
          ),
          child: window,
        ),
        ZPositioned(
        ...
        ZPositioned(
          translate: _theme.dimensionData.upperStripePosition,
          child: _ZStripe.rearfromTheme(_theme),
        ),
        ZPositioned(
          translate: _theme.dimensionData.lowerStripePosition,
          child: _ZStripe.rearfromTheme(_theme),
        ),
        ZPositioned(
          translate: _theme.dimensionData.fenderPosition,
          child: fender,
        ),
      ],
    );
...
class _ZBusFrontSide extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final window = _ZWindow.doubleLargeFromTheme(_theme);
    final fender = _ZFender.rearfromTheme(_theme);
    final leftLight = _ZLight.frontFromTheme(_theme);
    final rightLight = _ZLight.frontFromTheme(_theme);

    final lightHeight = (body.height / 2) -
        (window.height) -
        (_theme.dimensionData.bodyTopPadding * 2) -
...
class _ZBusBodySide extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final body = ZRect(
      width: _theme.dimensionData.bodyWidth,
      color: _theme.colorScheme.busColor,
      height: _theme.dimensionData.bodyHeight,
      fill: true,
    );

    final windows = _ZWindow.smallFromTheme(_theme).fillArea(
      width: body.width,
      height: body.height,
      padding: _theme.dimensionData.smallWindowHorizontalPadding,
      offset: ZVector.only(y: -_theme.dimensionData.bodyTopPadding),
    )..removeLast();

    final door = _ZDoor.fromTheme(theme: _theme);
    final fender = _ZFender.sidefromTheme(_theme);
    ...
    return ZGroup(
      ...
      children: [
        ...
        ZPositioned(
          translate: _theme.dimensionData.upperStripePosition,
          child: _ZStripe.sidefromTheme(_theme),
        ),
        ZPositioned(
          translate: _theme.dimensionData.lowerStripePosition,
          child: _ZStripe.sidefromTheme(_theme),
        ...
        ZPositioned(
          translate: ZVector.only(
            ...
            x: (body.width / 2) -
                (door.width / 2) -
                _theme.dimensionData.doorHorizontalPadding,
          ),
          child: door,
        ),
      ],
...
class _ZStripe extends StatelessWidget {
  ...
  factory _ZStripe.sidefromTheme(ZBusTheme theme) {
    return _ZStripe(
  ...
  factory _ZStripe.rearfromTheme(ZBusTheme theme) {
    return _ZStripe(
      width: theme.dimensionData.rearWidth,
      height: theme.dimensionData.stripeHeight,
      color: theme.colorScheme.stripesColor,
...
class _ZFender extends StatelessWidget {
  ...
  factory _ZFender.sidefromTheme(ZBusTheme theme) {
    return _ZFender(
      width: theme.dimensionData.bodyWidth,
  ...
  factory _ZFender.rearfromTheme(ZBusTheme theme) {
    return _ZFender(
      width: theme.dimensionData.rearWidth,
      height: theme.dimensionData.fenderHeight,
      color: theme.colorScheme.fenderColor,
...
class _ZWindow extends StatelessWidget {
  ...
  factory _ZWindow.smallFromTheme(ZBusTheme theme) => _ZWindow(
  ...
  factory _ZWindow.largeFromTheme(ZBusTheme theme) => _ZWindow(
  ...
  factory _ZWindow.doubleLargeFromTheme(ZBusTheme theme) => _ZWindow(
        width: theme.dimensionData.largeWindowWidth -
            (theme.dimensionData.largeWindowHorizontalPadding * 2),
...
// TODO(alestiago): Should reuse since it's the same as from car.
class _ZWheel extends StatelessWidget {
  const _ZWheel({Key? key}) : super(key: key);
...
class _ZLight extends StatelessWidget {
  ...
  factory _ZLight.frontFromTheme(ZBusTheme theme) {
    return _ZLight(
  ...
  factory _ZLight.rearFromTheme(ZBusTheme theme) {
    return _ZLight(
